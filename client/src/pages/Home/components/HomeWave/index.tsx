    ...
    <>
      <div className={s.container} id="wave">
        ...
        <div className={s.line1}>
          <div className={s.wave1} style={{ backgroundImage: `url(${wave1})` }} />
        </div>
        <div className={s.line2}>
          <div className={s.wave2} style={{ backgroundImage: `url(${wave2})` }} />
        </div>
        <div className={s.line3}>
          <div className={s.wave3} style={{ backgroundImage: `url(${wave3})` }} />
        </div>
      </div>
    </>
  );
